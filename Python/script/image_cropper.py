...
def img_cropper(save_path, image_path, resolution=224, size=448):
    ...
    for i in range(0,height//size):
        for j in  range(0,width//size):
            ...
            cv2.imwrite(filename=f"{save_path}/img_x{i}_y{j}.jpg", img=img_tmp)
...
if __name__ == '__main__':
    ...
    img_cropper(args.save_path, args.image_path, args.resolution, args.size)
